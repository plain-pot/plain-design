        ...
        <div>
            <DemoRow title={'基本用法'}>
                <PlButtonGroup>
                    ...
                    <PlButton label={'Dropdown为无根节点的组件'}/>
                </PlButtonGroup>
            </DemoRow>
            ...
            <DemoRow title={'宽高设置'}>
                <PlDropdown height={150} width={80}>
                    {{
                        default: <PlButton label={'Dropdown'}/>,
                        popper: (
                            <PlDropdownMenu>
            ...
            <DemoRow title={'触发器'}>
                <PlButtonGroup>
                    {['click', 'focus', 'hover'].map(trigger => (
                        <PlDropdown key={trigger} trigger={trigger}>
                            {{
                ...
                <PlButtonGroup>
                    <PlDropdown trigger={'manual'} v-model={state.val[0]}>
                        {{
