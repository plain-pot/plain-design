    ...
    return () => (
        <div>
            ...
            <DemoRow title={'时间范围'}>
                ...
                <PlTime v-model-start={val[19]} v-model-end={val[20]} range/>
                <PlTime v-model-start={val[19]} v-model-end={val[20]} range/>
            </DemoRow>
            <DemoRow title={'格式化值以及显示值'}>
                ...
                <DemoRow title={'范围'}>
                    ...
                    <PlTime v-model-start={val[34]} v-model-end={val[35]} range displayFormat="HH时mm分ss秒" valueFormat="HHmmss"/>
                </DemoRow>
            </DemoRow>
            <DemoRow title={'最大最小值'}>
                <DemoLine>
                ...
                <DemoRow title={'范围'}>
                    ...
                    <PlTime v-model-start={val[37]} v-model-end={val[38]} range displayFormat="HH时mm分ss秒" valueFormat="HHmmss" max="121212" min="040404"/>
                </DemoRow>
            </DemoRow>
            <DemoRow title={'四种视图'}>
                <DemoRow title={'时'}>
