        ...
        <div className={'demo-color'}>
            {state.fontColor.map(list => (
                <DemoRow key={list.title} title={list.title}>
                    <div className={'doc-theme-font-color-list'}>
                        {list.data.map(item => (
                            <div className={'doc-theme-font-color-item'} key={item.clz}>
                                <div className={item.clz}>{item.desc}</div>
                                <div>.{item.clz}</div>
                            </div>
                        ))}
                    </div>
            ...
            <DemoRow title={state.statusBackground.title}>
                <div className={'doc-theme-background-color-list doc-theme-background-status'}>
                    {state.statusBackground.data.map(item => (
                        <div className={`doc-theme-font-color-item ${item.clz}`} key={item.clz}>
                            <div>
                                <span>{item.desc}</span>
                                <span>.{item.clz}</span>
                            </div>
            ...
            <DemoRow title={state.disabledBackgroundColor.title}>
                <div className={'doc-theme-background-color-list doc-theme-background-status doc-theme-background-disabled'}>
