...
const MenuData: MenuGroup[] = [
    {
        name: '组合函数', children: [
            ...
            {name: 'useCollect', page: '/use/useCollect', complete: true},
        ]
    },
    {
        name: '基础', children: [
    ...
    },
    {
        name: '表单元素', children: [
            ...
            {name: 'ColorPicker', title: '颜色选择', page: '/normal/ColorPicker', complete: true},
            ...
            {name: 'Img', title: '图片上传', page: '/normal/Img', complete: true},
        ]
    },
    {
        name: '表单示例', children: [
