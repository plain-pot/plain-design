...
const MenuData: MenuGroup[] = [
    ...
    },
    {
        name: '表单元素', children: [
            ...
            {name: 'Loading', title: '加载', page: '/normal/DemoLoading', complete: false},
            ...
            {name: 'ColorPicker', title: '颜色选择', page: '/normal/ColorPicker', complete: false},
    ...
    },
    {
        name: '表格', children: [
            ...
            {name: 'Edit Control', title: '编辑控制', page: '/table/table-plc-editable', complete: false},
