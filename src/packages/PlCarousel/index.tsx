        ...
        return {
            ...
            render: () => (
                <div className={classes.value} style={styles.value} ref={onRef.el}>
                    {slots.default()}
                    {slots.cover.isExist() && <div className="pl-carousel-cover">
                        {slots.cover()}
                    </div>}

                    {!props.disabledOperator && <div className="pl-carousel-operator">
                        <div className="pl-carousel-operator-btn pl-carousel-operator-prev" onClick={handler.onPrev}>
                            <PlIcon icon="el-icon-arrow-left"/>
                        </div>
                        <div className="pl-carousel-operator-btn pl-carousel-operator-next" onClick={handler.onNext}>
