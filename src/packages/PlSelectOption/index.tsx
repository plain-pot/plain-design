            ...
            render: () => {
                return (
                    ...
                    <div
                        ...
                        {!!panel && isShow.value && <>
                            {!!panel.props.multiple && !props.group ? <PlCheckbox customReadonly modelValue={isSelected.value} className="pl-select-option-checkbox"/> : null}
                            {!!props.icon && <PlIcon icon={props.icon} className="pl-select-option-icon"/>}
