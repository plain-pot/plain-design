...
export const CascadePanelProps = {
    ...
    renderContent: {type: Function as PropType<(data: { node: CascadeNode, index: number }) => ReactNode>},// 渲染内容的渲染函数
    ...
    setup({props, scopeSlots, event: {emit}}) {
        ...
        return {
            ...
            render: () => {
                ...
                const filterList = (
                    <div className="pl-item pl-cascade-list pl-cascade-filter-list" key={0}>
                        <PlScroll>
                            <PlList>
                ...
                return (
                    <div className="pl-cascade-panel">
                        {!!props.filterText ? filterList : (
                            <PlList>
                                {isEmpty ? (
                                    <div className="pl-cascade-list" key="empty">
                                        {empty}
                                    </div>
                                ) : cascadeList}
                            </PlList>
