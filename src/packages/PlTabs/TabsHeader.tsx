import {classnames, designComponent, onBeforeUnmount, onMounted, PropType, reactive, useRefs, useStyles} from "plain-design-composition"
            ...
            render: () => (
                <div className="pl-tabs-header" ref={onRef.el}>
                    <div className="pl-tabs-header-list" style={listStyles.value} ref={onRef.list}>
                        ...
                        <i className="pl-tabs-header-indicator" style={indicatorStyle.value}/>
                    </div>
                </div>
            )
        }
