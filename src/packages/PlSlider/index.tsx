        ...
        return {
            ...
            render: () => (
                <div className={classes.value} style={styles.value} ref={onRef.el}>
                            ...
                            <div className="pl-slider-step">
                                {
                                    steps.value.map((item) => (
                                        <span className="pl-slider-step-item-wrapper" key={item}>
                                        <div className="pl-slider-step-item" style={stepItemStyles.value as any}/>
                                    </span>
                                    ))
                                }
                            </div>
                    ...
                    <div className="pl-slider-progress" style={progressStyles.value}>
                        <span className="pl-slider-dot-wrapper pl-slider-dot-wrapper-start" onMouseDown={(e) => handler.dragstart(e.nativeEvent, true)}><span className="pl-slider-dot"><span className="pl-slider-dot-inner">
                            {!!props.tooltip && <span className="pl-slider-dot-tooltip">{startTooltip.value}</span>}
                        </span></span></span>
                        <span className="pl-slider-dot-wrapper pl-slider-dot-wrapper-end" onMouseDown={e => handler.dragstart(e.nativeEvent, false)}><span className="pl-slider-dot"><span className="pl-slider-dot-inner">
                            {!!props.tooltip && <span className="pl-slider-dot-tooltip">{endTooltip.value}</span>}
                        </span></span></span>
                    </div>
                </div>
            )
