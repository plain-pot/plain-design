        ...
        return {
            ...
            render: () => (
                <div className={classes.value} style={styles.value} ref={onRef.el}>
                    ...
                    {state.status === ImageUploaderStatus.empty && <div className="pl-image-uploader-empty" onClick={handler.onClick}>
                        <PlIcon icon="el-icon-picture"/>
                        <span>待上传</span>
                    </div>}
                    {state.status === ImageUploaderStatus.fail && <div className="pl-image-uploader-fail" onClick={handler.onClick}>
                        <PlIcon icon="el-icon-close"/>
                        <span>上传失败</span>
                    </div>}
                    <div className="pl-image-uploader-button-group">
                        <div className="pl-image-uploader-button" onClick={handler.onClick}>
                            <PlIcon icon="el-icon-upload"/>
                        </div>
                        <div className="pl-image-uploader-button" onClick={handler.onClickDelete}>
