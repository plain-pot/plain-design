...
export const PlDatePanelDate = designComponent({
    ...
    emits: {
        ...
        onMouseleaveDateList: (e: React.MouseEvent) => true,
    },
    setup({props, event: {emit}}) {
        ...
        const render = {
            date: () => {
                const Wrapper: any = DatePanelWrapper({
                    ...
                    center: (<>
                        ...
                        {!!props.datetime && (<span className="pl-date-base-panel-date-time-label" onClick={() => methods.changeView(DateView.time)}>
                    ...
                    content: (<>
                        <ul className="pl-date-base-panel-date-week-list">
                            {weekList.value.map(item => (
                                <li className="pl-date-base-panel-item pl-date-base-panel-date-week-item" key={item}>
                        ...
                        <ul className={'pl-date-base-panel-date-list'} {...createEventListener({onMouseLeave: emit.onMouseleaveDateList})}>
                            {dateList.value.map((item, index) => (
                                DatePanelItemWrapper({
                                    ...
                                    Node: <li
                                        className={classnames(['pl-date-base-panel-date-item', {'pl-date-base-panel-date-item-other-month': !item.externals.isSelectMonth,}])}
            ...
            time: () => {
                ...
                return mergeProps({child: Wrapper, attrs: {className: 'pl-date-base-panel-time', direction: 'horizontal', key: 'time'}})
            },
        }

        return {
            render: () => (
                <div className="pl-date-base-panel-date-wrapper pl-date-base-panel">
